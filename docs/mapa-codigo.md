...
| --- | ---: | --- | --- |
| `js/dashboard.js` | 4766 | Dashboard, Cocina, Logistica, Rutas, inventario, alertas operativas | Mezcla de modulos que pueden afectarse entre si |
